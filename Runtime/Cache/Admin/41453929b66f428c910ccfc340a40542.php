		...
		<div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
			<div class="widget am-cf">
				<div class="widget-head am-cf">
					<div class="widget-title  am-cf"><?php echo ($otherdata[0]); ?></div>
				</div>
				<div class="widget-body am-fr">
					<div class="am-u-sm-12">
						<?php $thead = $otherdata[1][0]; $tbody = $otherdata[1][1]; ?>
						<table width="100%" class="am-table am-table-compact am-table-bordered am-table-striped tpl-table-black">
							<thead>
								<tr>
									<?php if(is_array($thead)): $i = 0; $__LIST__ = $thead;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><th><?php echo ($item); ?></th><?php endforeach; endif; else: echo "" ;endif; ?>
								</tr>
							</thead>
							<tbody>
								<?php if(is_array($tbody)): $i = 0; $__LIST__ = $tbody;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><tr>
										<?php if(is_array($item)): $i = 0; $__LIST__ = $item;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><td>
											<?php echo ($val); ?>
